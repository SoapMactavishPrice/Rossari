...
import getProductData from '@salesforce/apex/SendTdsFileFromAccount.getProductData';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import getFiledDisplay from '@salesforce/apex/SendTdsFileFromAccount.getFiledDisplay';
import getDocumentUrl from '@salesforce/apex/SendTdsFileFromAccount.getDocumentUrl';
import getEmailDetails from '@salesforce/apex/SendTdsFileFromAccount.getEmailDetails';
import sendMailToCustomer from '@salesforce/apex/SendTdsFileFromAccount.sendMailToCustomer';
import getLead from '@salesforce/apex/SendTdsFileFromAccount.getLead';
import requestApproval from '@salesforce/apex/SendTdsFileFromAccount.requestApproval';
import updateApproversAndSendEmails from '@salesforce/apex/DocumentApprovalHandlerForAccount.updateApproversAndSendEmails';
import isRequestDocumentSubmitted from '@salesforce/apex/DocumentApprovalHandlerForAccount.isRequestDocumentSubmitted';
import getDocumentModel from '@salesforce/apex/DocumentApprovalHandlerForAccount.getDocumentModel';
import uploadDocuments from '@salesforce/apex/DocumentApprovalHandlerForAccount.uploadDocuments';
import sendLeadDocumentEmail from '@salesforce/apex/DocumentApprovalHandlerForAccount.sendLeadDocumentEmail';
import savePreviousViewType from '@salesforce/apex/DocumentApprovalHandlerForAccount.savePreviousViewType';
import getPreviousViewType from '@salesforce/apex/DocumentApprovalHandlerForAccount.getPreviousViewType';
import saveRemarks from '@salesforce/apex/DocumentApprovalHandlerForAccount.saveRemarks';
