...
//                     statusDisplay: this.getStatusDisplay(exp.status, exp.isPendingWithCurrentUser, exp.currentApprover),
...
//             return status; // Show actual status like "Approved by Zonal Head"
//         } else if (status && status.includes('Rejected')) {
//             return status; // Show actual status like "Rejected by Business HOD"
//         } else {
//             return `Pending with ${currentApprover}`;
//         }
//     }
...
//     // Update UI immediately after bulk approval
...
//                         status: this.getUpdatedStatus(expense),
//                         statusDisplay: this.getStatusDisplay(this.getUpdatedStatus(expense), false, expense.currentApprover),
//                         statusBadgeClass: this.getStatusBadgeClass(this.getUpdatedStatus(expense), false),
...
//             // Re-group expenses to update user group status
//             this.groupedExpenses = this.groupExpensesByUser(this.filteredExpenses);

//             console.log('UI updated after bulk approval');

//             // Force refresh the template by re-assigning the array
...
//     //     if (recordType === 'RBL') {
//     //         if (approvalLevel === 'Level 1') {
//     //             return 'Approved by Z.H.';
//     //         } else if (approvalLevel === 'Level 2') {
//     //             return 'Approved by Bus. HOD';
//     //         }
//     //     } else if (recordType === 'Unitop_Tristar') {
//     //         if (approvalLevel === 'Level 1') {
//     //             return 'Apv. by CSI';
//     //         } else if (approvalLevel === 'Level 2') {
//     //             return 'Apv. by Bus. HOD';
//     //         }
//     //     }
//     //     return 'Approved';
//     // }

//     // Get updated status after approval - with abbreviated format
//     getUpdatedStatus(expense) {
//         const recordType = expense.recordType;
//         const approvalLevel = expense.currentApprovalLevel;
...
export default class NewExpenseForm extends NavigationMixin(LightningElement) {
    ...
    //     if (isPendingWithCurrentUser) {
    //         return 'Pending Your Approval';
    //     } else if (status && status.includes('Apr.')) {
    //         return status; // Show actual status like "Apr. by Zonal Head"
    //     } else if (status && status.includes('Rej.')) {
    //         return status; // Show actual status like "Rej. by Business HOD"
    //     } else {
    //         return `Pending with ${currentApprover}`;
    //     }
    // }
